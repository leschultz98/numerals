...
class VietnameseNumeralsTestCase(unittest.TestCase):
    ...
    def test_north_numerals(self):
        dict_number = {96: 'chín mươi sáu', 405: 'bốn trăm linh năm',
        ...
        for key, value in dict_number.items():
            self.assertEqual(integer_to_vietnamese_numeral(key), value)

    def test_south_numerals(self):
        dict_number = {96: 'chín mươi sáu', 405: 'bốn trăm lẻ năm',
                       1915: 'một ngàn chín trăm mười lăm',
                       5061: 'năm ngàn không trăm sáu mươi mốt',
